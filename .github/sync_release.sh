...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AcornElectron_MiSTer.git"
CORE_NAME=(AcornElectron)
...
UPSTREAM_CORE_NAME=(AcornElectron)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(AcornElectron.qpf)
COMPILATION_OUTPUT=(output_files/AcornElectron.rbf)
